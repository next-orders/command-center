...
export const Modal = ({ title, isOpened, toggle, children }: ModalProps) => {
  return (
    <>
      <div
      ...
      />
      <div
        className="z-40 fixed left-0 top-0 w-full max-w-lg max-h-[100dvh] overflow-y-auto p-2 m-0 pb-20 shadow-none rounded-2xl -translate-x-full data-[active=true]:translate-x-0 data-[active=true]:right-0 data-[active=true]:mx-auto transition-transform"
        data-active={isOpened}
      >
